...
const laboratories = [
  ...
  { name: 'Network Laboratory', description: 'Networking, servers, and cybersecurity environment.', capacity: 40, status: 'Unavailable' as const },
  ...
  { name: 'ComLab1', description: 'General computing and programming resources.', capacity: 50, status: 'Available' as const },
  { name: 'ComLab2', description: 'General computing and programming resources.', capacity: 50, status: 'Available' as const },
  { name: 'ComLab3', description: 'General computing and programming resources.', capacity: 50, status: 'Available' as const },
  { name: 'ComLab4', description: 'General computing and programming resources.', capacity: 50, status: 'Available' as const },
  { name: 'ComLab5', description: 'General computing and programming resources.', capacity: 50, status: 'Available' as const },
];
